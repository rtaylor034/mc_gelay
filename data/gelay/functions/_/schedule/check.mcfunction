...
function gelay:_/schedule/check.1 with storage gelay:var check

execute if data storage gelay:var check.jobs[] run function gelay:_/schedule/run with storage gelay:var check.jobs[0]
